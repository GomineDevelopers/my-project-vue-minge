<template>
  <div class="bg1 proposal-cover">
    <div class="proposal-list">
      <div class="row status status-success">
        <div class="note">提案1</div>
        <div class="block">
          <div class="title">本次党建工作十分重要大家要积极参与。</div>
          <div class="content">民革贵阳市委召开八届三次会议</div>
          <div class="c1"></div>
          <div class="c2"></div>
          <div class="c3">已通过</div>
        </div>
      </div>
